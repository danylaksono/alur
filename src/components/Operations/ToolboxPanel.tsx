...
import { ChevronDown, ChevronRight, Download, Loader2, Package, Play, Plug, Search } from 'lucide-react';
                    ...
                    <div key={groupKey} className="ml-3">
                      ...
                      {(groupOpen || !group) && items.map((entry) => (
                        <button
                          ...
                          className="group flex w-full items-center gap-1.5 rounded-md py-1 pl-4 pr-1 text-left hover:bg-blue-50"
                        >
