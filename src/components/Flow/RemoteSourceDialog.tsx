    ...
    <div className="fixed inset-0 z-[400] flex items-center justify-center bg-slate-900/40 p-4" onClick={onClose}>
      ...
      >
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="pressable shrink-0 rounded-lg bg-slate-900 px-3 py-1.5 text-xs font-semibold text-white hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-40"
              >
              ...
              <div className="space-y-1.5">
                {REMOTE_CATALOG.map((entry) => (
                  <button
                    ...
                    className="pressable w-full rounded-lg border border-slate-200 p-2 text-left transition-colors hover:border-blue-200 hover:bg-blue-50/60"
                  >
                ...
                <div>
                  ...
                  {bbox ? (
                    ...
                    <button
                      ...
                      className="pressable flex w-full items-center justify-center gap-1.5 rounded-lg border border-dashed border-slate-300 py-2 text-[11px] font-semibold text-slate-500 hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700"
                    >
        ...
        <div className="flex shrink-0 items-center justify-end gap-2 border-t bg-slate-50 px-4 py-3">
          <button type="button" onClick={onClose} className="pressable rounded-lg px-3 py-1.5 text-xs font-semibold text-slate-500 hover:bg-slate-100">
            Cancel
          </button>
          <button
            type="button"
            ...
            className="pressable flex items-center gap-1.5 rounded-lg bg-slate-900 px-4 py-1.5 text-xs font-semibold text-white hover:bg-slate-700 disabled:cursor-not-allowed disabled:opacity-40"
          >
