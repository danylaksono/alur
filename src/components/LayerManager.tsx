              ...
              return (
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1">
                        ...
                        <span className="mt-0.5 flex items-center gap-1 truncate text-[11px] uppercase tracking-wide text-slate-400">
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <label className="flex min-w-0 items-center gap-2 text-[11px] font-semibold uppercase tracking-wider text-slate-400">
                      Opacity
                      <input
                        type="range"
                        min={0.1}
                  ...
                  {isNodeSelected && (
                    <div className="mt-2 rounded-md bg-slate-100 px-2 py-1 text-[11px] font-semibold uppercase tracking-wide text-slate-500">
                      Linked node selected
                    </div>
                  )}

                  {selectedFeatureCount > 0 && (
                    <div className="mt-2 flex items-center justify-between gap-2 rounded-md bg-orange-50 px-2 py-1 text-[11px] font-semibold uppercase tracking-wide text-orange-700">
                      <span>{selectedFeatureCount.toLocaleString()} features selected</span>
                      <button
                        type="button"
                        onClick={() => clearFeatureSelection(layer.id)}
                        className="rounded border border-orange-200 bg-white px-1.5 py-0.5 text-[10px] hover:bg-orange-100"
                      >
                        Clear
                      </button>
                    </div>
                  ...
                  {filterCount > 0 && (
                    <div className="mt-2 flex items-center justify-between gap-2 rounded-md bg-sky-50 px-2 py-1 text-[11px] font-semibold uppercase tracking-wide text-sky-700">
                      <span>{filterCount.toLocaleString()} visual filters</span>
                      <button
                        type="button"
                        onClick={() => clearLayerFilters(layer.id)}
                        className="rounded border border-sky-200 bg-white px-1.5 py-0.5 text-[10px] hover:bg-sky-100"
                      >
                        Clear
                      </button>
                    </div>
