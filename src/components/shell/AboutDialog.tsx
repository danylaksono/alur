    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
          <h2 id="about-alur-title" className="text-sm font-bold text-slate-800">About ALUR</h2>
          <button
            ref={closeButtonRef}
            type="button"
            onClick={() => setAboutOpen(false)}
        ...
        <div className="px-5 py-5">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h3 className="text-base font-extrabold tracking-[0.14em] text-slate-900">ALUR</h3>
              <p className="mt-0.5 text-xs font-medium text-slate-500">Interactive visual analytics</p>
            </div>
          </div>

          <p className="mt-4 text-sm leading-relaxed text-slate-600">
            A browser-based workspace for exploring data through coordinated tables, charts, maps,
            and reproducible visual workflows.
          </p>

          <div className="mt-5 border-t border-slate-100 pt-4">
            <p className="text-[10px] font-semibold uppercase tracking-wide text-slate-400">Created by</p>
            <a
              href={AUTHOR_URL}
              target="_blank"
              rel="noreferrer"
