          ...
          {isProjectMenuOpen && (
            ...
            >
              <button
                ...
                role="menuitem"
                onClick={startRename}
                className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-[11px] font-semibold text-slate-600 hover:bg-slate-50"
              >
              ...
              <button
                ...
                className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-[11px] font-semibold text-slate-600 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-35"
          ...
          >
            ...
            <div className="space-y-4 p-5">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-dashed border-slate-200 bg-slate-50 px-4 py-5 text-xs font-bold text-slate-600 hover:border-sky-300 hover:bg-sky-50 hover:text-sky-700"
              >
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2 rounded-lg border border-slate-200 p-3">
                  ...
                  <button
                    ...
                    className="flex h-8 w-full items-center justify-center gap-1.5 rounded-md bg-slate-900 text-[11px] font-bold text-white disabled:opacity-40"
                  >
                    {isRemoteLoading && (
              ...
              {missingSources.map((source) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-md bg-slate-900 px-3 py-1.5 text-[11px] font-bold text-white hover:bg-slate-700"
                  >
                    Choose file
                  </button>
                </div>
