...
export const AnalysisContextBar = () => {
  ...
  return (
    <div
      className="flex min-h-9 shrink-0 items-center gap-2 overflow-x-auto border-b border-slate-200 bg-white px-3 py-1.5 text-[11px]"
      role="region"
    ...
    >
      {dataset && (
        <span className="flex items-center gap-1.5 whitespace-nowrap font-bold text-slate-700">
          <Database className="h-3.5 w-3.5 text-slate-500" />{dataset.name}
        </span>
      )}
