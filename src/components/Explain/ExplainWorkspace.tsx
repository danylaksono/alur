...
import { AlertCircle, ArrowDown, ArrowUp, BarChart3, Database, GripVertical, MonitorPlay, NotebookPen, PanelLeft, Plus, RefreshCw, Share2, SlidersHorizontal, Trash2 } from 'lucide-react';
